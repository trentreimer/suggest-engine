...
This example uses hard-coded strings to demonstrate `wordAt()`, `suggestAt()`, `nextWords()` 
and `recordWord()`, but an application would often supply strings programmatically.
